...
export default {
  ...
  assets: {
    'index.csr.html': {size: 8030, hash: '867a7012ba757b290ae478692faedbb191b9a1a10aa01cf38660bd4acad551ab', text: () => import('./assets-chunks/index_csr_html.mjs').then(m => m.default)},
    'index.server.html': {size: 1350, hash: '85e18bdf18d4fa5f09221db04183d00806cf3749b0940a149c26be5f01557768', text: () => import('./assets-chunks/index_server_html.mjs').then(m => m.default)},
